...
var messageData = {
  ...
  NEED_WATER: MiscUtils.makeConstantDescriptor('Watering fields needed'),
  ...
  NEED_MORE_FIELD: MiscUtils.makeConstantDescriptor('More field needed'),
  ...
  NOT_ENOUGH_WATER: MiscUtils.makeConstantDescriptor('Not enough water'),
